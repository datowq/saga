...
function Hero() {
  return (
    <>
      ...
      >
        <img src={seriouslygraphical} className="absolute bottom-0 right-0 pointer-events-none w-72"/>
        ...
        <div className="px-36">
          ...
          <img src={quotecat} width={500} className="absolute right-10 bottom-4" />
      ...
      <section id="chapters" className="text-blue pt-16 pb-32 relative">
        <img src={awesomeadventure} className="absolute top-0 right-0 pointer-events-none w-72"/>
